...
from mgraph_ai_service_plantuml.config                                 import LAMBDA_DEPENDENCIES__BASE__SERVICE
from mgraph_ai_service_plantuml.utils.Version                          import version__mgraph_ai_service_plantuml
from mgraph_ai_service_plantuml.utils.deploy.Deploy__Service           import Deploy__Service
...
class test_Deploy__Service__base():     # Base class for deployment tests - override stage in subclasses
    ...
    def test_5__invoke__function_url(self):
        version = {'version': version__mgraph_ai_service_plantuml}
