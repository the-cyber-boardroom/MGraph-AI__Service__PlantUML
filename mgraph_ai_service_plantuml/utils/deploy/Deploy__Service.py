...
from mgraph_ai_service_plantuml.config                                  import SERVICE_NAME, LAMBDA_DEPENDENCIES__BASE__SERVICE
from mgraph_ai_service_plantuml.fast_api.lambda_handler                 import run
