# MGraph AI Service PlantUML

[![Current Release](https://img.shields.io/badge/release-v0.6.0-blue)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__PlantUML/releases)
...
[![CI Pipeline - DEV](https://github.com/the-cyber-boardroom/MGraph-AI__Service__PlantUML/actions/workflows/ci-pipeline__dev.yml/badge.svg)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__PlantUML/actions)
...
To create a new service from this template, see [Creating Services from MGraph-AI__Service__PlantUML](docs/dev/non-functional-requirements/version-1_0_0/README.md).
...
# or
uvicorn mgraph_ai_service_plantuml.fast_api.lambda_handler:app --reload --host 0.0.0.0 --port 10011
```
...
# Run with coverage
pytest --cov=mgraph_ai_service_plantuml
...
- 🐛 Issues: [GitHub Issues](https://github.com/the-cyber-boardroom/MGraph-AI__Service__PlantUML/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/the-cyber-boardroom/MGraph-AI__Service__PlantUML/discussions)
